...
export default function MonthPicker({ value, onChange }) {
  ...
  return (
    <div className="flex items-center gap-0.5 sm:gap-2">
      <Button variant="ghost" size="icon" className="size-7 sm:size-8 shrink-0" onClick={prev}>
      ...
      <Button variant="ghost" size="icon" className="size-7 sm:size-8 shrink-0" onClick={next}>
